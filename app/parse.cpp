...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    options.add_options()
      ...
      ("enforce-same-font",  "Deprecated compatibility option (ignored)",                        cxxopts::value<bool>()->implicit_value("true"))
      ("horizontal-cell-tolerance", "Deprecated compatibility option (ignored)",                cxxopts::value<double>())
      ("word-space-factor",  "Deprecated compatibility option (ignored)",                        cxxopts::value<double>())
      ("line-space-factor",  "Deprecated compatibility option (ignored)",                        cxxopts::value<double>())
      ("line-space-factor-with-space", "Deprecated compatibility option (ignored)",              cxxopts::value<double>())
